    ...
    <div class="space-y-6">
      <div class="page-header">
        <div class="flex items-center gap-4 min-w-0">
          ...
          <h1 class="text-xl sm:text-2xl font-bold truncate">{{ t('tasks.list') }}</h1>
        </div>
      ...
      <p-card>
        <p-table [value]="taskStore.tasks()" [loading]="taskStore.isLoading()" [paginator]="true" [rows]="10" [tableStyle]="{ 'min-width': '48rem' }">
